...
public class SystemFileProcess {
    ...
    @Autowired
    SystemTransactionRepo systemTransactionRepo;
    ...
    private void processCSV(MultipartFile file, Map<String, String> mapping) throws Exception {
        ...
        while ((row = reader.readNext()) != null) {
            ...
            SystemTransaction entity = new SystemTransaction();
            ...
            systemTransactionRepo.save(entity);
        }
    ...
    // ================= FIELD MAPPING =================
    private void mapField(SystemTransaction entity, String field, String value) {
